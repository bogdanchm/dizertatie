...
OpenFace_Extractor_path = '/home/bogdan/Dizertatie/OpenFace/build/bin/FeatureExtraction'
seq_length = 20
...
def Feature_extractor(folder, cur_dir):
    ...
    for video in tqdm(videos):
        ...
        #     os.mkdir(os.path.join(proc_dir))
        #     os.chdir(proc_dir)
...
def join_data():
    ...
    if not os.path.exists(test_path):
        os.mkdir(test_path)
    data = {}
    data['Test'] = pickle.load(open(test_path,'rb'))
    pickle.dump(data, open(test_path,'wb'))
